<template>
  <div class="max-w-6xl py-4 mx-auto">
    <header class="relative z-20 inline-flex items-center justify-between w-full">
    ...
    <main class="flex items-center py-4">
      <div class="w-1/2">
        <div>
          ...
          <h1 class="mb-1 text-5xl font-bold text-gray-700">
            Be good to your skin.
          </h1>
          <h2 class="mb-4 text-4xl font-bold text-gray-700">
            You will wear it everyday for you.
          </h2>
          <div class="inline-flex items-center justify-center mb-8 space-x-2">
            <star-rated class="w-4 h-4" />
            <star-rated class="w-4 h-4" />
            <star-rated class="w-4 h-4" />
            <star-rated class="w-4 h-4" />
          ...
          <div class="inline-flex items-center mb-16 space-x-10">
            ...
            <button
              class="px-6 py-3 text-sm font-thin text-white rounded-full bg-app-primary"
            >
              Add to Cart
            </button>
          </div>
          <div class="inline-flex space-x-6">
            <div class="inline-flex items-center space-x-2">
              <span class="px-4 py-4 bg-red-100 rounded-full">
                <car class="w-4 h-4" />
              </span>
            ...
            <div class="inline-flex items-center space-x-2">
              ...
              <span class="text-sm font-bold">24x7 Service</span>
            </div>
            <div class="inline-flex items-center space-x-2">
              <span class="px-4 py-4 bg-red-100 rounded-full">
                <repeat class="w-4 h-4" />
              </span>
              <span class="text-sm font-bold">Free Return</span>
            </div>
          </div>
        </div>
      </div> 
...
import naturalProduct from './components/icons/natural-product.svg'
import starRated from './components/icons/star-rated.svg'
import starUnrated from './components/icons/star-unrated.svg'
import car from './components/icons/car.svg'
import timer from './components/icons/timer.svg'
import repeat from './components/icons/repeat.svg'
</script>
